...
import { collection, CollectionReference, query, orderBy, limit, getDocs, startAfter, Timestamp, addDoc, doc } from "firebase/firestore";
import { CommentColRef, CommentData, CommentRef, CommentSnap, myUser, PostData, PostRef, Rating, Vote } from "../../types";
...
export const fetchCommentRefs = async (pid: string, amount: number, startDoc?: CommentSnap): Promise<[CommentRef[], CommentSnap]> => {
...
export const publishComment = async (pid: string, uid: string, content: string, publishData?: Timestamp) => {
